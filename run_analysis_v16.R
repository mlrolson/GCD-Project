# GCD PROJECT - Samsung Accelerometer Data, Version 16
...
library(dplyr)
wrkdr <- getwd()
setwd(wrkdr); getwd()       # checks for the correct working directory for this project
#
#
# Reviewer please note that extracted .txt files should in a folder UCI HAR Dataset
# in your working directory for the following code to operate on the project data.
# And the training data in a subfolder "train" and the test data in a subfolder "test".
# See file = " ..." in code below.
